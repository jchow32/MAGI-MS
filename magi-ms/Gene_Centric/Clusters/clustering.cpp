...
bool isValidCluster(clustersSelected *clus)
{
	...
	//printf("CLuster was not add %f %f %f\n", clus->averageEdgeDensity, clus->averageCoexpresion, minCoExprValueInClus(clus));
...
int potClusIdCanMergeToClusCount=0;
float potClusIdCanMergeToClusWeight[50000];
...
for (int count2=0; count2<10; count2++)
{
	...
	{
		if (listNodes[count].weightCases>0.9 && nodeInCluster(clus, count)==false)
		{
